...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-blue-500 text-start text-base font-medium text-blue-400 bg-slate-800 focus:outline-none focus:text-blue-300 focus:bg-slate-700 focus:border-blue-400 transition duration-150 ease-in-out'
